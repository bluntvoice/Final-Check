...
This architecture extends independent Quick Compare without replacing its Engine, frozen Snapshot / Comparison payloads or result / review UI. Implementation progresses in the [task](../tasks/project-template-version-management-v0.md) Phase order. Phases 1–3 implement Template Center, Contract Projects and Version / Round management; project comparisons / lifecycle remain designs for Phases 4–5, not claimed implemented yet.
